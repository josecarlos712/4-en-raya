...
- Añadida la comprobación de ganador por filas y columnas ( falta por diagonales :/ )
...
## TO-DO
- Comprobación del tablero cada vez que se pone una ficha en busca de un ganador (falta diagonales)
