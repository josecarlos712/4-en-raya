...
to-report MCTS:get-rules [s]
  let m map [c -> remove 0 c] matrix:to-row-list (MCTS:get-content s) ;pasa la matriz a una lista de columnas y elimina los ceros para saber                                                                      ;cuales son los movimientos posibles en cada columna
